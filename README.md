...
```
cd existing_repo
git remote add origin https://gitlab.com/neo25-rgb-group/neo25-rgb-project.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/neo25-rgb-group/neo25-rgb-project/-/settings/integrations)
...
##I had to add this part since when i uploaded my gitlab work, it removed my readme and uploaded the readme from gitlad but it just add from it.
